 ...
 */
@Configuration
@ComponentScan(basePackages = "com.tmall.store.config")
public class WechatOpenConfig
{
	...
	public WxMpConfigStorage wxOpenMpConfigStorage()
	{
		...
		wxMpInMemoryConfigStorage.setAppId(wechatAccountConfig.getMyOpenAppid());
		wxMpInMemoryConfigStorage.setSecret(wechatAccountConfig.getMyOpenSecret());
